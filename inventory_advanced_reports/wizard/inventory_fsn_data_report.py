...
class InventoryFSNDataReport(models.TransientModel):
    ...
    opening_stock = fields.Float(string="Stock Inicial")
    closing_stock = fields.Float(string="Valor de Cierre")
    ...
    data_id = fields.Many2one('inventory.fsn.report', string="Datos FSN")
